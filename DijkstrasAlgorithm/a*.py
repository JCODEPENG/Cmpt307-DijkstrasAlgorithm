...
for inp in range(0,20):
    ...
    p1 = []
    p2 = []
    #extra array that contains the coordinates of endingpoint
    p3 = []
    p3.append(float(graphx[endingpoint-1]))
    p3.append(float(graphy[endingpoint-1]))
